...
import { BlueH5Heading, H6Heading, PageSubHeading, H5Heading } from "../../components/common/Headings";

const schema = yup.object().shape({
  name: yup.string().required("Please fill in name").min(5, "Name must contain over 5 characters"),
  area: yup.string().required("Please fill in area").min(2, "Area must contain over 2 characters"),
  generalabouttext: yup.string().required("Please fill in the general about text").min(25,"This text must contain over 25 characters"),
  theplacetext: yup.string().required("Please fill in the place text").min(25,"This text must contain over 25 characters"),
  guestaccesstext: yup.string().required("Please fill in the guest access text").min(25,"This text must contain over 25 characters"),
  otherthingsworthnotingtext: yup.string().required("Please fill in the this text").min(15,"This text must contain over 15 characters"),
  cancellationterms: yup.string().required("Please fill in the cancellation terms").min(15,"This text must contain over 15 characters"),
  checkintimeaftertext: yup.string().required("Please fill in the check in after time"),
  checkouttimetext: yup.string().required("Please fill in the check out time"),
  howmanypeople: yup.string().required("Please fill in how many people(guests)"),
...
function Addplace() {
  ...
  return (
    <Container className="add-place__container mt-5" style={{paddingBottom: 200}}>
      ...
      <Form onSubmit={handleSubmit(onSubmitHandler)}>
        <fieldset disabled={submitting}>
            ...
            <Col className="px-3" xs={12} sm={12} md={12} lg={6}>
              ...
              <Row className="mx-1">
                ...
                <Col xs={12} sm={12} md={12} >
                  <input placeholder="Name" type="text" {...register("name", { required: true })} className="inputs input__borderradius--small"/>
              ...
              <Row className="mx-1 mb-2">
                <H6Heading text="Area" />
                <Col xs={12} sm={12} md={12}>
                  <input placeholder="Area" type="text" {...register("area", { required: true})} className="inputs input__borderradius--small"/>
                  <div className="form__errormessage--contactform-right">
              ...
              <Row className="mx-1">
                ...
                <Col xs={12} sm={12} md={12}>
                  <textarea placeholder="General about text" type="text" rows={5} {...register("generalabouttext", { required: true})} className="textarea"/>
                  <div className="form__errormessage--contactform-right">
                    {errors.generalabouttext && <FormErrorMessage>{errors.generalabouttext.message}</FormErrorMessage>}
                  </div>
                </Col>
              </Row>
              <Row className="mx-1">
                ...
                <Col xs={12} sm={12} md={12}>
                  <textarea placeholder="The place" type="text" rows={5} {...register("theplacetext", { required: true })} className="textarea"/>
                  <div className="form__errormessage--contactform-right">
                    {errors.theplacetext && <FormErrorMessage>{errors.theplacetext.message}</FormErrorMessage>}
                  </div>
                </Col>
              </Row>
              <Row className="mx-1">
                ...
                <Col xs={12} sm={12} md={12}>
                  <textarea placeholder="Guest access" type="text" rows={5} {...register("guestaccesstext", { required: true})} className="textarea"/>
                  <div className="form__errormessage--contactform-right">
                    {errors.guestaccesstext && <FormErrorMessage>{errors.guestaccesstext.message}</FormErrorMessage>}
                  </div>
                </Col>
              </Row>
              <Row className="mx-1">
                ...
                <Col xs={12} sm={12} md={12}>
                  <textarea placeholder="Other things worth noting" type="text" rows={5} {...register("otherthingsworthnotingtext", { required: true})} className="textarea"/>
                  <div className="form__errormessage--contactform-right">
                    {errors.otherthingsworthnotingtext && <FormErrorMessage>{errors.otherthingsworthnotingtext.message}</FormErrorMessage>}
                  </div>
                </Col>
              </Row>
              <Row className="mx-1">
                ...
                <Col xs={12} sm={12} md={12}>
                  <textarea placeholder="Cancellation terms" type="text" rows={5} {...register("cancellationterms", { required: true})} className="textarea"/>
                  <div className="form__errormessage--contactform-right">
                    {errors.cancellationterms && <FormErrorMessage>{errors.cancellationterms.message}</FormErrorMessage>}
                  </div>
                </Col>
              </Row>
                  ...
                  <H6Heading text="Rules" />
                    <Col xs={12} sm={12} md={12} className="mb-2">
                            <Form.Check type={'checkbox'} style={{ paddingLeft: 0 }}  className="d-flex justify-content-between">
                                        ...
                                        <input className="input__small--width" type={'time'} {...register("checkintimeaftertext", { required: true })} />
                            </Form.Check>
                            <div className="form__errormessage--contactform-right">
                              {errors.checkintimeaftertext && <FormErrorMessage>{errors.checkintimeaftertext.message}</FormErrorMessage>}
                            </div>
                    </Col>
                    <Col xs={12} sm={12} md={12} className="mb-2">
                            <Form.Check type={'checkbox'} style={{ paddingLeft: 0 }}  className="d-flex justify-content-between">
                            ...
                            <div className="form__errormessage--contactform-right">
                              {errors.checkouttimetext && <FormErrorMessage>{errors.checkouttimetext.message}</FormErrorMessage>}
                            </div>
                    </Col>
                    <Col xs={12} sm={12} md={12} className="my-2">
                            <Form.Check type={'checkbox'} style={{ paddingLeft: 0 }}  className="d-flex justify-content-between">
                                        <Form.Check.Label className="">{<IconComponentRules type="nosmoking" />}</Form.Check.Label>
                                        <input className="green" type={'checkbox'} {...register("nosmoking", { required: true })} />
                            </Form.Check>
                    </Col>
                    <Col xs={12} sm={12} md={12} className="my-2">
                            <Form.Check type={'checkbox'} style={{ paddingLeft: 0 }}  className="d-flex justify-content-between">
                                        <Form.Check.Label className="">{<IconComponentRules type="nopartiesorevents" />}</Form.Check.Label>
                                        <input className="green" type={'checkbox'} {...register("nopartiesorevents", { required: true })} />
                            </Form.Check>
                    </Col>
                </Row>
                <Row className="mx-1 my-4">
                <H6Heading text="Health and safety" />
                  <Col xs={12} sm={12} md={12} className="mb-2">
                          <Form.Check type={'checkbox'} style={{ paddingLeft: 0 }}  className="d-flex justify-content-between">
                                      ...
                                      <input className="green" type={'checkbox'} {...register("nearbylakeriverwater", { required: true })} />
                          </Form.Check>
                  </Col>
                  <Col xs={12} sm={12} md={12} className="my-2">
                          <Form.Check type={'checkbox'} style={{ paddingLeft: 0 }} className="d-flex justify-content-between">
                                      <Form.Check.Label className="">{<IconComponentHealthSafety type="heightwithoutrailingsorsafety" />}</Form.Check.Label>
                                      <input className="green" type={'checkbox'}  {...register("heightwithoutrailingsorsafety", { required: true })} />
                          </Form.Check>
                  </Col>
                  <Col xs={12} sm={12} md={12} className="my-2">
                              <Form.Check type={'checkbox'} style={{ paddingLeft: 0 }} className="d-flex justify-content-between">
                                      <Form.Check.Label className="">{<IconComponentHealthSafety type="carbonmonoxidealarm" />}</Form.Check.Label>
                                      <input className="green" type={'checkbox'}  {...register("carbonmonoxidealarm", { required: true })} />
                              </Form.Check>
                  </Col>
                  <Col xs={12} sm={12} md={12} className="my-2">
                              <Form.Check type={'checkbox'} style={{ paddingLeft: 0 }} className="d-flex justify-content-between">
                                      <Form.Check.Label className="">{<IconComponentHealthSafety type="smokedetectoralarm" />}</Form.Check.Label>
                                      <input className="green" type={'checkbox'}  {...register("smokedetector", { required: true })} />
                              </Form.Check>
                  </Col>
              </Row>
            </Col>
          ...
          <Col className="px-3" xs={12} sm={12} md={12} lg={6}>
            ...
            <Row className="mx-1 my-4">
                ...
                <Row className="mx-1 my-4">
                    <Col xs={12} sm={12} md={12} className="mt-2">
                                <Form.Check type={'radio'} style={{ paddingLeft: 0 }} className="d-flex justify-content-between">
                                    <Form.Check.Label>{`People`}<FontAwesomeIcon className="icon-margin mx-3" icon={faPerson} /></Form.Check.Label>
                                    <input className="inputs input__borderradius--small input__small--width" type={'text'} {...register("howmanypeople", { required: true })}/>
                                </Form.Check>
                                <div className="form__errormessage--contactform-right">
                                  {errors.howmanypeople && <FormErrorMessage>{errors.howmanypeople.message}</FormErrorMessage>}
                                </div>
                    </Col>
                    <Col xs={12} sm={12} md={12} className="my-2">
                                <Form.Check type={'radio'} style={{ paddingLeft: 0 }} className="d-flex justify-content-between">
                                ...
                                <div className="form__errormessage--contactform-right">
                                  {errors.howmanybedrooms && <FormErrorMessage>{errors.howmanybedrooms.message}</FormErrorMessage>}
                                </div>
                    </Col>
                    <Col xs={12} sm={12} md={12} className="my-2">
                                <Form.Check type={'radio'} style={{ paddingLeft: 0 }} className="d-flex justify-content-between">
                                ...
                                <div className="form__errormessage--contactform-right">
                                  {errors.howmanybathrooms && <FormErrorMessage>{errors.howmanybathrooms.message}</FormErrorMessage>}
                                </div>
                    </Col>
                    <Col xs={12} sm={12} md={12} className="my-2">
                                <Form.Check type={'radio'} style={{ paddingLeft: 0 }} className="d-flex justify-content-between">
                                ...
                                <div className="form__errormessage--contactform-right">
                                  {errors.howmanybeds && <FormErrorMessage>{errors.howmanybeds.message}</FormErrorMessage>}
                                </div>
                    </Col>
                </Row>
                ...
                <Row className="mx-1 my-4">
                    ...
                    <div className="form__errormessage--contactform-right">
                      {errors.ratingdecimal && <FormErrorMessage>{errors.ratingdecimal.message}</FormErrorMessage>}
                    </div>
                </Row>
          ...
          <Row className="d-flex justify-content-center mt-5">
                <button className="btn__holidaze--primary w-50 mt-5"
                  type="submit"
                >
